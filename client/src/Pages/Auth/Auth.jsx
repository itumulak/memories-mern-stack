...
import { handleObjectDataChange, loadingDiv } from "../../util";
                    ...
                    <Paper className="flex flex-col gap-y-4 p-6 rounded">
                        <>
                            ...
                            <form className="flex gap-6 flex-col" onSubmit={(e) => handleSubmit(e)}>
                                {success && 
                                <Grow in>
                                    <Alert severity="success">{isSignUp ? `Sign Up Successful` : `Sign In Successful`}</Alert>
                                </Grow>}
                                {error.length > 0 &&
                                <Grow in>
                                ...
                                <Button disabled={submitting} type="submit" variant="contained" color="primary" size="large">
